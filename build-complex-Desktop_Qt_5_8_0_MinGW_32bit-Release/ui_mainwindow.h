...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMaximumSize(QSize(343, 210));
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        sizePolicy.setHeightForWidth(centralWidget->sizePolicy().hasHeightForWidth());
        centralWidget->setSizePolicy(sizePolicy);
        centralWidget->setMinimumSize(QSize(343, 210));
        centralWidget->setMaximumSize(QSize(344, 211));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        firstF_ExpForm->setText(QApplication::translate("MainWindow", "Exp form", Q_NULLPTR));
        firstF_firstLine->setText(QString());
        firstF_changeFormButton->setText(QApplication::translate("MainWindow", "Change form", Q_NULLPTR));
        secondF_ExpForm->setText(QApplication::translate("MainWindow", "Exp form", Q_NULLPTR));
        secondF_firstLine->setText(QString());
        secondF_changeFormButton->setText(QApplication::translate("MainWindow", "Change form", Q_NULLPTR));
        label->setText(QApplication::translate("MainWindow", "Select operation:", Q_NULLPTR));
        sumButton->setText(QApplication::translate("MainWindow", "Sum", Q_NULLPTR));
        subButton->setText(QApplication::translate("MainWindow", "Subtraction", Q_NULLPTR));
        divButton->setText(QApplication::translate("MainWindow", "Division", Q_NULLPTR));
        mulButton->setText(QApplication::translate("MainWindow", "Multiplication", Q_NULLPTR));
        label_3->setText(QApplication::translate("MainWindow", "Result:", Q_NULLPTR));
        changeFormButton->setText(QApplication::translate("MainWindow", "Change result form", Q_NULLPTR));
